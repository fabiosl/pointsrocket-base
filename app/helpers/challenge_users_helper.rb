module ChallengeUsersHelper
  ...
  @@admin_options = {
    title: 'views.dashboard.admin.challenges_users.index.title',
    ...
    buttons: {
      index_add: 'views.dashboard.admin.challenges_users.buttons.add',
    },
    edit: {
      title_add: 'views.dashboard.admin.challenges_users.buttons.add',
      title_edit: 'views.dashboard.admin.challenges_users.edit.title',
    },
    errorMapping: {
      challenge_id: 'views.dashboard.admin.challenges_users.fields.challenge',
      user_id: 'views.dashboard.admin.challenges_users.fields.user',
      url: 'views.dashboard.admin.challenges_users.fields.url',
      description: 'views.dashboard.admin.challenges_users.fields.description',
      status: 'views.dashboard.admin.challenges_users.fields.status',
      feedback: 'views.dashboard.admin.challenges_users.fields.feedback',
    },
    form: {
      params_to_send: {
        notify: true
      ...
      fields: [
        {
          name: :challenge_id,
          display_name: 'views.dashboard.admin.challenges_users.fields.challenge',
          type: "reference",
          options: [],
        ...
        {
          name: :user_id,
          display_name: 'views.dashboard.admin.challenges_users.fields.user',
          input: :text,
          readonly: true
        },
        {
          name: :url,
          display_name: 'views.dashboard.admin.challenges_users.fields.url',
          input: :text,
          readonly: true
        },
        {
          name: :description,
          display_name: 'views.dashboard.admin.challenges_users.fields.description',
          input: :textarea,
          readonly: true
        },
        {
          name: :status,
          display_name: 'views.dashboard.admin.challenges_users.fields.status',
          input: :select,
          options: [{
            value: "pending",
            label: 'views.dashboard.admin.challenges_users.statuses.pending'
          },{
            value: "approved",
            label: 'views.dashboard.admin.challenges_users.statuses.approved'
          },{
            value: "declined",
            label: 'views.dashboard.admin.challenges_users.statuses.declined'
          }]
        },
        {
          name: :feedback,
          display_name: 'views.dashboard.admin.challenges_users.fields.feedback',
          input: :textarea
        },
      ],
    },
