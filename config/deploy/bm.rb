set :stage, :bm
set(:branch, ENV['branch'] || 'multiple_sites')
set :deploy_user, 'elife-vm'


# This is used in the Nginx VirtualHost to specify which domains
# the app should appear on. If you don't yet have DNS setup, you'll
# need to create entries in your local Hosts file for testing.
set :server_name, "advocacy.buzzmonitor.com.br"
...
server 'staging.pointsrocket.com', user: 'elife-vm', roles: %w{web app db}, primary: true
