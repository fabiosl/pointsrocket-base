...
def my_main
  ...
  key = "ya29.Gl39AyiUA5onaexuDdcWZHI4flNte3EDuukSnfHVkjAZ_8zaqf_vpa7EhnFdRGdo9sxsxy1Mm366GgRHlQdDTVPXExG6BkWgHw9hE7gqpLlmGmcRKmq5kpCBZhGvgKc"
  ...
  # credentials = {
  #          "token" =>
  #     "expires_at" => 1488055072,
  #     "token_credential_uri" =>"https://accounts.google.com/o/oauth2/token",
  # }

  # authorization = Signet::OAuth2::Client.new(credentials)
  # # authorization.issued_at = Time.at(credentials['issued_at'].to_i)
